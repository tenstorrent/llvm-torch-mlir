...
// torch-mlir uses AtenQuantizePerChannelOp and AtenIntReprOp for per channel
// quantization. These two ops are processed and converted together to
// stablehlo.uniform_quantize op.
namespace {
...
// torch-mlir uses Aten_MakePerChannelQuantizedTensorOp and AtenDequantizeSelfOp
// in pair to represent per tensor dequantization. These two ops are converted
// together to stablehlo.uniform_dequantize op
namespace {
